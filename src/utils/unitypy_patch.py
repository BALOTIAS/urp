"""
UnityPy patches and fixes for the Unofficial Retro Patch application.

This module contains patches and fixes for UnityPy library issues
...
def compress_etcpak(
    ...
    """
    Patched compress_etcpak function to fix UnityPy compression issues.
...
def patch_unitypy() -> None:
    """
    Apply patches to UnityPy to fix known issues.
    ...
    try:
        ...
        warnings.warn(
            f"[UNOFFICIAL RETRO PATCH] Failed to monkey patch compress_etcpak: {e}. "
            "Ensure UnityPy structure is as expected."
        )